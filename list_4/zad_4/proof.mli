...
val proof : (string * Logic.formula) list -> Logic.formula -> proof

(** Zamienia ukończony dowód na twierdzenie *)
val qed : proof -> Logic.theorem
...
val goal : proof -> ((string * Logic.formula) list * Logic.formula) option
  ...
  (nowy aktywny cel) (nowy cel)
        ...
        ----------------------(→E)  (nowy cel)
                ...
                ----------------------------(→E)
                            ...
                            -----(⊥E)
                            Γ ⊢ φ *)
val apply : Logic.formula -> proof -> proof
...
val apply_thm : Logic.theorem -> proof -> proof
